 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "Este notebook apresenta a análise exploratória de dados (EDA) utilizada no Projeto Aplicado I.\n",
    "\n",
    "Ele inclui:\n",
    "- Inspeção da base\n",
    ...
    "- Resumo estatístico\n",
    "- Visualização gráfica das vendas semanais\n"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Tentativa inicial (falha proposital)\n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "## 📉 Gráfico: Tendência das Vendas Semanais"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "  labs(title = \"Tendência das Vendas Semanais\",\n",
    "       x = \"Data\",\n",
    "       y = \"Vendas Semanais\")"
   ]
  },
  {
   ...
   "source": [
    ...
    "## ✅ Fim da EDA\n",
    "\n",
    "Este notebook compõe a Análise Exploratória utilizada no Storytelling e Metodologia do projeto."
   ]
  }
 ],
 "metadata": {
